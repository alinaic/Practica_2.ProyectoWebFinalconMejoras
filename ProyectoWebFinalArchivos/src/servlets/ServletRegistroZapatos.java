...
public class ServletRegistroZapatos extends HttpServlet {
	...
	protected void service(HttpServletRequest request,
		...
		// Creamos una carpeta 
		File directorioSubidas = new File("proyectoweb");
		System.out.println("Vamos a crear el archivo");
		...
		if(categoria.equals("Hombre") || categoria.equals("Mujer") || 
		   categoria.equals("NiÒos") || categoria.equals("NiÒas")) {
			...
			request.getRequestDispatcher("registrarZapatos.jsp").forward(
					request, response);
			return;
		}
		...
		Zapatos nuevoZapatos = new Zapatos(categoria, temporada, talla,
				material, tipo, color, marcas, imagen);
