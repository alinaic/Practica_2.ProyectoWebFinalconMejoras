...
public class ServletRegistroCliente extends HttpServlet {
	...
	protected void service(HttpServletRequest request,
		...
		if (matcher.matches()) {
			...
			request.getRequestDispatcher("registrarClientes.jsp").forward(
					request, response);
			return;
		}
		...
		Clientes nuevoClientes = new Clientes(nombre, calle, numero_calle,
				codigo_postal, telefono, email, particular, empresa);
